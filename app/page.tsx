  ...
  return (
    <main className="min-h-screen bg-[#FFFBF5] text-slate-800 px-6 py-10 max-w-[480px] mx-auto">
      ...
      <div className="mt-8 bg-white border border-slate-200 rounded-[24px] p-6 shadow-sm">
        ...
        <a href="https://buy.stripe.com/test_28E8wI2U2..." className="mt-6 flex w-full justify-center bg-[#F06A2E] text-white font-bold py-4 rounded-full text-[18px]">Activer - 25€/mois</a>
